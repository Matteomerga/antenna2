    ...
    def run(self):
        ...
        while self.running:
            if self.ser.in_waiting >= 18:
                ...
                # Controlla la perdita dei pacchetti
                if joule != ultimo_joule + 1 and joule != 1:  
                    pacchetti_perduti = joule - ultimo_joule - 1
                    self.pacchetti_persi += pacchetti_perduti
                ultimo_joule = joule  # Aggiorna l'ultimo valore di joule
